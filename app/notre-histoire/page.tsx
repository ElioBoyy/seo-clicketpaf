...
export const metadata: Metadata = {
  title: 'Notre Histoire | Click et Paf',
  ...
  openGraph: {
    title: 'Notre Histoire | Click et Paf',
    description: 'Découvrez l\'histoire fascinante de Click et Paf, de nos humbles débuts à notre position actuelle de leader dans le développement web et le marketing digital en France.',
    url: 'https://clicketpaf.fr/notre-histoire',
    ...
    <>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="space-y-6">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">{"L'Ère de l'IA et du Big Data"}</h2>
            <p>{"À partir de 2019, Click et Paf a commencé à investir massivement dans l'intelligence artificielle et le big data. L'entreprise a développé des outils propriétaires d'analyse de données et d'optimisation SEO basés sur l'IA, révolutionnant une fois de plus leur approche du marketing digital."}</p>
            <p>{"En 2020, malgré les défis posés par la pandémie mondiale, Click et Paf a su s'adapter rapidement, aidant de nombreuses entreprises à accélérer leur transformation digitale. Cette période a vu l'entreprise doubler ses effectifs et tripler son chiffre d'affaires."}</p>
          </section>
